...
class TurnosController extends Controller
{
 ...
 {
     $turnoId=$_GET['id'];
    $this->model->deleteTurno($turnoId); 
  ...
  public function vistaModificar(){
      ...
      $datosTurnos = $this->model->getById($_GET['id']);      
        $datos['turnos'] = $datosTurnos;
      
        return view('/turnos.modificar', compact('datos'));
    }
    
    public function modificaTurno(){
